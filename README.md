...
Fight back with an **M4A1-S** and a **M1911** — and unlock bug spray, a PPD-40, a flamethrower and an AWP as the waves go on — and scavenge **ammo crates** and **med kits**
...
| W A S D | Move |
| Mouse | Aim |
| Left click | Shoot / spray / flame |
| Right click | Scope (AWP) — otherwise throws |
| Shift | Sprint |
| Space | Jump |
| R | Reload |
| G | Throw selected throwable |
| T | Cycle throwable (stun / frag / molotov) |
| 1 – 6 / Mouse wheel / Q | Switch weapon (Q = last used) |
| Esc | Pause |
...
- **Weapons**:
  1. **M4A1-S** — 30-round mag, 34 dmg, full-auto.
  2. **M1911** — 7-round mag, 55 dmg, very accurate.
  3. **Bug spray** (wave 2) — short-range mist. Shreds small spiders, barely tickles big ones, and slows everything it touches so they rarely manage to leap. Refill with spray cans.
  4. **PPD-40** (dropped by the wave 4 boss — every boss drops it until you grab it) — 71-round drum, very fast fire.
  5. **Flamethrower** (wave 6) — 9 m stream of fire that sets spiders alight, bosses included. Runs on fuel: collect **gas cans** scattered around the jungle, dropped by spiders and by every boss.
  6. **AWP** (wave 8) — 450 damage, hold right-click to scope, bullets punch through every spider in a line. Inaccurate unless scoped.
...
- `spider.stl`, `m4a1.stl`, `m1911.stl`, `ppd40.stl`, `flamethrower.stl`, `awp.stl` — 3D models (simplified and reoriented from the originals); the bug spray can is built in code
